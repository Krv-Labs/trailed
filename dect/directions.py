...
def generate_multiview_directions(
    ...
    Examples
    --------
    >>> from dect.directions import generate_multiview_directions
...
def generate_spherical_grid_directions(
    ...
    Examples
    --------
    >>> from dect.directions import generate_spherical_grid_directions
...
def generate_directions(
    ...
    Examples
    --------
    >>> from dect.directions import generate_directions
